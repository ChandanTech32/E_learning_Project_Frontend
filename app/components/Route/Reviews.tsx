...
//             We take pride in empowering the next generation of developers. Our
//             students don't just learn to code; they learn to build real-world
//             solutions. Explore their journeys and see how our detailed,
//             project-based curriculum has transformed their professional lives
//           </p>
//         </div>
//         <br />
//         <br />
...
export const reviews = [
  ...
  },
  {
    ...
    profession: "computer systems engineering student | Zimbabwe",
    comment:
      "Thanks for your amazing programming tutorial channel! Your teaching style is outstanding and very helpful.",
  },
  {
    name: "Mina Davidson",
    avatar: "https://randomuser.me/api/portraits/women/2.jpg",
    profession: "Junior Web Developer | Indonesia",
    comment:
      "I had the pleasure of exploring E-learning and I was thoroughly impressed with my experience.",
  },
  {
    name: "Rosemary Smith",
    avatar: "https://randomuser.me/api/portraits/women/3.jpg",
    profession: "Full stack web developer | Algeria",
    comment:
      "Your content is very special. The videos are detailed and helpful for beginners to complete projects.",
  },
  {
    name: "Laura Mckenzie",
    avatar: "https://randomuser.me/api/portraits/women/4.jpg",
    profession: "Full stack web developer | Canada",
    comment:
      "Join E-learning! It focuses on practical applications and helps improve real-world programming skills.",
  },
];
...
const Reviews = (props: Props) => {
  return (
    <div className="w-[90%] 800px:w-[85%] m-auto">
      ...
      <div className="grid grid-cols-1 gap-[25px] md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 mb-12">
        {reviews.map((i, index) => (
